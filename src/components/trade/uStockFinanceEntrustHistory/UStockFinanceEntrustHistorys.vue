<template>
  <section>
    ...
    <el-table :data="forms.list"
      ...
      <el-table-column prop="id" label="用户当日委托ID" show-overflow-tooltip></el-table-column>

      <el-table-column prop="client.cust_info" min-width="120px" label="客户信息"
                       show-overflow-tooltip></el-table-column>

      <el-table-column prop="entrust_time" min-width="120" label="委托时间"
                       show-overflow-tooltip></el-table-column>
      ...
      <!--<el-table-column prop="caution_money" label="用户保证金" show-overflow-tooltip></el-table-column>-->

      <!--<el-table-column prop="finance_amount" label="配资借款额" show-overflow-tooltip></el-table-column>-->

      <el-table-column prop="product_type" label="产品类型"
                       show-overflow-tooltip></el-table-column>

      <el-table-column prop="entrust_status" label="委托状态"
                       show-overflow-tooltip></el-table-column>

      <el-table-column prop="opt_entrust_price" label="委托价格"
                       show-overflow-tooltip></el-table-column>

      <el-table-column v-if="role_group=='System'" prop="entrust_amount" label="委托数量"
                       show-overflow-tooltip></el-table-column>

      <el-table-column v-if="role_group=='System'" prop="entrust_no" label="委托编号"
                       show-overflow-tooltip></el-table-column>

      <el-table-column prop="parent_stock_finance_id" label="母账户ID" show-overflow-tooltip></el-table-column>

      <el-table-column prop="entrust_bs" label="买卖方向" show-overflow-tooltip></el-table-column>

      <el-table-column v-if="role_group=='System'" prop="entrust_source" label="委托来源"
                       show-overflow-tooltip></el-table-column>
    ...
    export default {
        ...
        data() {
            return {
                ...
                excel_url: 'uStockFinanceEntrustsHistory',
                excel_column_arr: [
                    'id', 'parent_stock_finance_id', ['client', 'cust_info'], 'entrust_time',
                    'option_code', 'option_name', 'caution_money', 'finance_amount', 'product_type',
                    'entrust_status', 'opt_entrust_price', 'entrust_amount', 'batch_no', 'entrust_bs', 'entrust_no', 'entrust_source'
                ],
                excel_title_arr: [
                    '用户当日委托ID', '母账户ID', '客户信息', '委托时间',
                    '合约编码', '合约简称', '用户保证金', '配资借款额', '产品类型',
                    '委托状态', '委托价格', '委托数量', '委托批号', '买卖方向', '委托编号', '委托来源'
                ],
                pickerOptions1: {},
                pickerOptions2: {},
                status_list: [
