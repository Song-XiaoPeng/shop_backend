<template>
    <div class="yl-clearfix">
        <div class="searchgrid">
            ...
            <input value=" 新增 " type="button" class="yl-input-button yl-float-left" @click="$router.push({name: '新增其他'})">
...
<script>
    ...
    import {otherList, otherDelete} from '../../api/content';
    export default {
        data() {
            return {
                filters: {
        ...
        methods: {
            ...
            handleEditProtocol: function (id) {
                this.$router.push({name: '修改其他', params: {id}});
            },
